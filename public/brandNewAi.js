...
function createAiTable(cfTable, cfColor) {
	...
	cfMoves.forEach(function(stepMove) {
		...
		var tTableValue =  1.1*(fTableValue - origTableValue) + (fMyHitValue - origMyHitValue) - (fHisHitValue - origHisHitValue)
		...
		cf2Moves.forEach(function(step2Move, moveNo) {
			...
			var tempValue =  1.1*(scndTableValue - origTableValue) + (scndMyHitValue-origMyHitValue) - (scndHisHitValue-origHisHitValue)//(scndHitValue - origHitValue) +* 10.01
