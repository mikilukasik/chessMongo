...
function getTableData(origTable, isWhite) { //, rtnSimpleValue) {
	...
	if(isWhite&&origTable[4][0][3]){	//we play with white and have not moved the king yet
		...
		if(sancolhat){
			...
			if(origTable[2][0][1]==2&&origTable[2][0][0]==2)lSancVal-=.01	//try to move out bishops
			if(origTable[5][0][1]==2&&origTable[5][0][0]==2)rSancVal-=.01
		}
	...
	if(!isWhite&&origTable[4][7][3]){	//we play with black and have not moved the king yet
		...
		if(sancolhat){
			...
			if(origTable[2][7][1]==2&&origTable[2][7][0]==1)lSancVal-=.01
			if(origTable[5][7][1]==2&&origTable[5][7][0]==1)rSancVal-=.01
		}
...
function createAiTable(cfTable, cfColor, skipScnd) {
	...
	cfMoves.forEach(function(stepMove, moveIndex) {
		...
		if(cfRetMoves.length == 0) {
			...
			if(cfColor){
				if((stepMove=='e1g1')||(stepMove=='e1c1'))sancValue+=.6	//sancoljon ha tud
				
			}else{
				if((stepMove=='e8g8')||(stepMove=='e8c8'))sancValue+=.6	//sancoljon ha tud
			}
